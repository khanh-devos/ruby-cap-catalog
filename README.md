...
[Video presentation](https://drive.google.com/file/d/1Km66n3_KDSNNz56if8WGyZWY2Fyqgipx/view?usp=drive_link)
...
```bash
  git clone https://github.com/khanh-devos/ruby-cap-catalog.git 
```
...
Feel free to check the [issues page](https://github.com/khanh-devos/ruby-cap-catalog/issues).
